...
const char* WIFINAME = "Create";
const char* PASS = "navneet1";
...
Serial.print(d);
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    String stringTempratureURL = "http://class.aarmontech.com/1/?temprature=";
    
    // we add our celsius data to above web address as "?temprature=ourvaluetosend"
    stringTempratureURL = stringTempratureURL + d;
